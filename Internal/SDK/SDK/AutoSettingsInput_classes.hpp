...
static_assert(alignof(IAutoSettingsInputConfigInterface) == 0x000001, "Wrong alignment on IAutoSettingsInputConfigInterface");
static_assert(sizeof(IAutoSettingsInputConfigInterface) == 0x000001, "Wrong size on IAutoSettingsInputConfigInterface");
