...
static_assert(alignof(IBPi_ProgressBars_C) == 0x000001, "Wrong alignment on IBPi_ProgressBars_C");
static_assert(sizeof(IBPi_ProgressBars_C) == 0x000001, "Wrong size on IBPi_ProgressBars_C");
