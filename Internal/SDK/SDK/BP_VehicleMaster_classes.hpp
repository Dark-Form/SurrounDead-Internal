...
public:
	...
	class ABP_PlayerCharacter_C*                  Player;                                            // 0x03E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UVehicleUI_C*                           VehicleUI;                                         // 0x03F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FString                                 Name_0;                                            // 0x03F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	bool                                          LightsOn_;                                         // 0x0408(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          UniqueVehicle_;                                    // 0x0409(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_40A[0x6];                                      // 0x040A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USpotLightComponent*>            Lights;                                            // 0x0410(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          Flipped;                                           // 0x0420(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          BloodSplatterEnabled;                              // 0x0421(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          DamageNumbersEnabled;                              // 0x0422(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          InRefuellingArea_;                                 // 0x0423(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsHeld;                                            // 0x0424(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_425[0x3];                                      // 0x0425(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        Duration;                                          // 0x0428(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          InRepairingArea_;                                  // 0x0430(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_431[0x7];                                      // 0x0431(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           NoiseTimer;                                        // 0x0438(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FVector                                InteractingActorLoc;                               // 0x0440(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 CurrentActor;                                      // 0x0458(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          InStorageArea_;                                    // 0x0460(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          GetOutPasseenger;                                  // 0x0461(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_462[0x2];                                      // 0x0462(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DamageMultiplier;                                  // 0x0464(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsHit_;                                            // 0x0468(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_469[0x7];                                      // 0x0469(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FS_ReplicatedContainerInfo>     MainJigContainers;                                 // 0x0470(0x0010)(Edit, BlueprintVisible, SaveGame, ContainsInstancedReference)
	TArray<struct FGuid>                          MainContainersIDs;                                 // 0x0480(0x0010)(Edit, BlueprintVisible, SaveGame)
	TArray<struct FS_InvWeight>                   InventoryWeight;                                   // 0x0490(0x0010)(Edit, BlueprintVisible, SaveGame)
	bool                                          EngineOn_;                                         // 0x04A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4A1[0x7];                                      // 0x04A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMaterial*>                      Colors;                                            // 0x04A8(0x0010)(Edit, BlueprintVisible)
	int32                                         VehicleColor;                                      // 0x04B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          RandomColorSelected_;                              // 0x04BC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4BD[0x3];                                      // 0x04BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class AActor* InteractingActor)> SpecialInteractionOption;         // 0x04C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Event_DamageX(float NewValue);
...
static_assert(sizeof(ABP_VehicleMaster_C) == 0x0004D0, "Wrong size on ABP_VehicleMaster_C");
...
static_assert(offsetof(ABP_VehicleMaster_C, Player) == 0x0003E8, "Member 'ABP_VehicleMaster_C::Player' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, VehicleUI) == 0x0003F0, "Member 'ABP_VehicleMaster_C::VehicleUI' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, Name_0) == 0x0003F8, "Member 'ABP_VehicleMaster_C::Name_0' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, LightsOn_) == 0x000408, "Member 'ABP_VehicleMaster_C::LightsOn_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, UniqueVehicle_) == 0x000409, "Member 'ABP_VehicleMaster_C::UniqueVehicle_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, Lights) == 0x000410, "Member 'ABP_VehicleMaster_C::Lights' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, Flipped) == 0x000420, "Member 'ABP_VehicleMaster_C::Flipped' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, BloodSplatterEnabled) == 0x000421, "Member 'ABP_VehicleMaster_C::BloodSplatterEnabled' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, DamageNumbersEnabled) == 0x000422, "Member 'ABP_VehicleMaster_C::DamageNumbersEnabled' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, InRefuellingArea_) == 0x000423, "Member 'ABP_VehicleMaster_C::InRefuellingArea_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, IsHeld) == 0x000424, "Member 'ABP_VehicleMaster_C::IsHeld' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, Duration) == 0x000428, "Member 'ABP_VehicleMaster_C::Duration' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, InRepairingArea_) == 0x000430, "Member 'ABP_VehicleMaster_C::InRepairingArea_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, NoiseTimer) == 0x000438, "Member 'ABP_VehicleMaster_C::NoiseTimer' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, InteractingActorLoc) == 0x000440, "Member 'ABP_VehicleMaster_C::InteractingActorLoc' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, CurrentActor) == 0x000458, "Member 'ABP_VehicleMaster_C::CurrentActor' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, InStorageArea_) == 0x000460, "Member 'ABP_VehicleMaster_C::InStorageArea_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, GetOutPasseenger) == 0x000461, "Member 'ABP_VehicleMaster_C::GetOutPasseenger' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, DamageMultiplier) == 0x000464, "Member 'ABP_VehicleMaster_C::DamageMultiplier' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, IsHit_) == 0x000468, "Member 'ABP_VehicleMaster_C::IsHit_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, MainJigContainers) == 0x000470, "Member 'ABP_VehicleMaster_C::MainJigContainers' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, MainContainersIDs) == 0x000480, "Member 'ABP_VehicleMaster_C::MainContainersIDs' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, InventoryWeight) == 0x000490, "Member 'ABP_VehicleMaster_C::InventoryWeight' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, EngineOn_) == 0x0004A0, "Member 'ABP_VehicleMaster_C::EngineOn_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, Colors) == 0x0004A8, "Member 'ABP_VehicleMaster_C::Colors' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, VehicleColor) == 0x0004B8, "Member 'ABP_VehicleMaster_C::VehicleColor' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, RandomColorSelected_) == 0x0004BC, "Member 'ABP_VehicleMaster_C::RandomColorSelected_' has a wrong offset!");
static_assert(offsetof(ABP_VehicleMaster_C, SpecialInteractionOption) == 0x0004C0, "Member 'ABP_VehicleMaster_C::SpecialInteractionOption' has a wrong offset!");
