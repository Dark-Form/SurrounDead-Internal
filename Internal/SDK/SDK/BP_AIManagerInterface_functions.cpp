...
void IBP_AIManagerInterface_C::Return_AI_Manager(class ABP_AIManager_C** AI_Manager)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIManagerInterface_C", "Return AI Manager");
...
void IBP_AIManagerInterface_C::Return_AI_Manager_Settings(struct FS_AIOptimization* AI_Settings)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIManagerInterface_C", "Return AI Manager Settings");
