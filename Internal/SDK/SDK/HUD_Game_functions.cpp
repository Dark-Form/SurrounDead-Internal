...
// const struct FStruct_Radio&             RadioStruct                                            (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// Parameters:
// const struct FStruct_POI&               POI                                                    (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// const class FText&                      InteractionText                                        (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FS_NotificationDetails&    NotificationDetails                                    (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// const class FText&                      AdditionalText                                         (BlueprintVisible, BlueprintReadOnly, Parm)
// const TMap<struct FGameplayTag, class FText>&Options                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm)
// const TMap<class FName, class FText>&   Stats                                                  (BlueprintVisible, BlueprintReadOnly, Parm)

void AHUD_Game_C::ShowInteractWidget(bool Visible_, const class FText& Name_0, const class FText& AdditionalText, const TMap<struct FGameplayTag, class FText>& Options, const TMap<class FName, class FText>& Stats)
{
	static class UFunction* Func = nullptr;
...
// const class FText&                      Container                                              (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      LootType                                               (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FGameplayTag&              OptionToUpdate                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FName                       StatToUpdate                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const class FText&                      Area_Name                                              (BlueprintVisible, BlueprintReadOnly, Parm)
