...
public:
	...
	class UBP_InteractWidgetOption_C*             CallFunc_Array_Get_Item_3;                         // 0x03C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator) == 0x0003D0, "Wrong size on BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator");
...
static_assert(offsetof(BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator, CallFunc_IsValid_ReturnValue_4) == 0x0003C0, "Member 'BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator, CallFunc_Array_Get_Item_3) == 0x0003C8, "Member 'BP_PowerGenerator_C_ExecuteUbergraph_BP_PowerGenerator::CallFunc_Array_Get_Item_3' has a wrong offset!");
