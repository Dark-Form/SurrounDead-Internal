...
public:
	...
	class FText                                   CallFunc_GetLootTableName_Text;                    // 0x0258(0x0018)()
	class UBPC_MinimapSystem_C*                   CallFunc_Get_Minimap_Component_ReturnValue;        // 0x0270(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsActive_ReturnValue;                     // 0x0278(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_279[0x7];                                      // 0x0279(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGameplayTag, class FText>        K2Node_MakeMap_Map;                                // 0x0280(0x0050)(ConstParm)
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD;                               // 0x02D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD_1;                             // 0x02D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD_2;                             // 0x02E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GetBoolCVar_ReturnValue;                  // 0x02F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface; // 0x02F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1; // 0x0310(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UPassiveSkillsComponent_C*              CallFunc_GetPassiveSkillsComponent_SkillsComponent; // 0x0330(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue_1;                // 0x0340(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool NewValue)>                K2Node_CreateDelegate_OutputDelegate;              // 0x0358(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_InteractingActor_2;                   // 0x0368(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetBoolCVar_ReturnValue_1;                // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_371[0x7];                                      // 0x0371(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IBPI_Player_C>         K2Node_DynamicCast_AsBPI_Player;                   // 0x0378(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue_2;                // 0x0390(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue_3;                // 0x0398(0x0008)(NoDestructor, HasGetValueTypeHash)
	class FText                                   Temp_text_Variable;                                // 0x03A0(0x0018)(ConstParm)
	bool                                          CallFunc_RequestServerData_Result;                 // 0x03B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3B9[0x7];                                      // 0x03B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_InteractingActor_1;                   // 0x03C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_Option;                               // 0x03C8(0x0008)(NoDestructor, HasGetValueTypeHash)
	class UUserWidget*                            CallFunc_SetupInventoryWidget_InventoryWidgetRef;  // 0x03D0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddJigWidgetToContent_Result;             // 0x03D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInventoryVisible__Result;               // 0x03D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 K2Node_Event_InteractingActor;                     // 0x03E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<struct FGameplayTag, class FText>        K2Node_Event_Options;                              // 0x03E8(0x0050)(ConstParm)
	...
	double                                        CallFunc_Multiply_DoubleDouble_B_ImplicitCast;     // 0x0440(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetLootTableName_Text) == 0x000258, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetLootTableName_Text' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Get_Minimap_Component_ReturnValue) == 0x000270, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Get_Minimap_Component_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_IsActive_ReturnValue) == 0x000278, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_IsActive_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_MakeMap_Map) == 0x000280, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_MakeMap_Map' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetHUD_HUD) == 0x0002D0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetHUD_HUD' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetHUD_HUD_1) == 0x0002D8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetHUD_HUD_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetHUD_HUD_2) == 0x0002E0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetHUD_HUD_2' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_RandomFloatInRange_ReturnValue) == 0x0002E8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetBoolCVar_ReturnValue) == 0x0002F0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetFloatCVar_ReturnValue) == 0x0002F4, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetFloatCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_AsBP_Jig_Character_Interface) == 0x0002F8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_AsBP_Jig_Character_Interface' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_bSuccess) == 0x000308, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_AsBP_Jig_Character_Interface_1) == 0x000310, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_AsBP_Jig_Character_Interface_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_bSuccess_1) == 0x000320, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_K2_SetTimer_ReturnValue) == 0x000328, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetPassiveSkillsComponent_SkillsComponent) == 0x000330, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetPassiveSkillsComponent_SkillsComponent' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000338, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_K2_SetTimer_ReturnValue_1) == 0x000340, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_K2_SetTimer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000348, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000350, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_CreateDelegate_OutputDelegate) == 0x000358, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_Event_InteractingActor_2) == 0x000368, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_Event_InteractingActor_2' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_GetBoolCVar_ReturnValue_1) == 0x000370, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_GetBoolCVar_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_AsBPI_Player) == 0x000378, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_AsBPI_Player' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_DynamicCast_bSuccess_2) == 0x000388, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_K2_SetTimer_ReturnValue_2) == 0x000390, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_K2_SetTimer_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_K2_SetTimer_ReturnValue_3) == 0x000398, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_K2_SetTimer_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, Temp_text_Variable) == 0x0003A0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_RequestServerData_Result) == 0x0003B8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_RequestServerData_Result' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_Event_InteractingActor_1) == 0x0003C0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_Event_Option) == 0x0003C8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_SetupInventoryWidget_InventoryWidgetRef) == 0x0003D0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_SetupInventoryWidget_InventoryWidgetRef' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_AddJigWidgetToContent_Result) == 0x0003D8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_AddJigWidgetToContent_Result' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_IsInventoryVisible__Result) == 0x0003D9, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_IsInventoryVisible__Result' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Not_PreBool_ReturnValue) == 0x0003DA, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_Event_InteractingActor) == 0x0003E0, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, K2Node_Event_Options) == 0x0003E8, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::K2Node_Event_Options' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_RetriggerableDelay_Duration_ImplicitCast) == 0x000438, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_RetriggerableDelay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer, CallFunc_Multiply_DoubleDouble_B_ImplicitCast) == 0x000440, "Member 'Master_AirdropContainer_C_ExecuteUbergraph_Master_AirdropContainer::CallFunc_Multiply_DoubleDouble_B_ImplicitCast' has a wrong offset!");
