...
class IBP_JigMPComponentInterface_C final
{
public:
...
static_assert(alignof(IBP_JigMPComponentInterface_C) == 0x000001, "Wrong alignment on IBP_JigMPComponentInterface_C");
static_assert(sizeof(IBP_JigMPComponentInterface_C) == 0x000001, "Wrong size on IBP_JigMPComponentInterface_C");
