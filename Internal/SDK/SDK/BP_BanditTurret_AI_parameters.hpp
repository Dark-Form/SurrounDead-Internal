...
public:
	...
	class AHUD_Game_C*                            CallFunc_GetGameHUD_HUD_4;                         // 0x0430(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 K2Node_Event_InteractingActor_1;                   // 0x04D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_Option;                               // 0x04E0(0x0008)(NoDestructor, HasGetValueTypeHash)
	class ABP_TurretGunPickup_C*                  CallFunc_FinishSpawningActor_ReturnValue;          // 0x04E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBPI_Player_C>         K2Node_DynamicCast_AsBPI_Player;                   // 0x04F0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0500(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetBehindObject__BehindObject_;           // 0x0501(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_502[0x6];                                      // 0x0502(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_InteractingActor;                     // 0x0508(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<struct FGameplayTag, class FText>        K2Node_Event_Options;                              // 0x0510(0x0050)(ConstParm)
	...
	float                                         CallFunc_MakeRotator_Yaw_ImplicitCast_1;           // 0x0564(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_MakeRotator_Yaw_ImplicitCast_2;           // 0x0568(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_MakeRotator_Yaw_ImplicitCast_3;           // 0x056C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_RetriggerableDelay_Duration_ImplicitCast; // 0x0570(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        K2Node_VariableSet_CurrentTime_ImplicitCast;       // 0x0578(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI) == 0x000580, "Wrong size on BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI");
...
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_GetGameHUD_HUD_4) == 0x000430, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_GetGameHUD_HUD_4' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x000438, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_Add_VectorVector_ReturnValue) == 0x000450, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_MakeTransform_ReturnValue) == 0x000470, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0004D0, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_Event_InteractingActor_1) == 0x0004D8, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_Event_Option) == 0x0004E0, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_FinishSpawningActor_ReturnValue) == 0x0004E8, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_DynamicCast_AsBPI_Player) == 0x0004F0, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_DynamicCast_AsBPI_Player' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_DynamicCast_bSuccess) == 0x000500, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_GetBehindObject__BehindObject_) == 0x000501, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_GetBehindObject__BehindObject_' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_Event_InteractingActor) == 0x000508, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_Event_Options) == 0x000510, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_Event_Options' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_MakeRotator_Yaw_ImplicitCast) == 0x000560, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_MakeRotator_Yaw_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_MakeRotator_Yaw_ImplicitCast_1) == 0x000564, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_MakeRotator_Yaw_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_MakeRotator_Yaw_ImplicitCast_2) == 0x000568, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_MakeRotator_Yaw_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_MakeRotator_Yaw_ImplicitCast_3) == 0x00056C, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_MakeRotator_Yaw_ImplicitCast_3' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_RetriggerableDelay_Duration_ImplicitCast) == 0x000570, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_RetriggerableDelay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000574, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI, K2Node_VariableSet_CurrentTime_ImplicitCast) == 0x000578, "Member 'BP_BanditTurret_AI_C_ExecuteUbergraph_BP_BanditTurret_AI::K2Node_VariableSet_CurrentTime_ImplicitCast' has a wrong offset!");
