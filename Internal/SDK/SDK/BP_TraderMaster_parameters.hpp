...
public:
	...
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface; // 0x0138(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1; // 0x0150(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UNarrativeComponent*                    CallFunc_GetNarrativeComponent_ReturnValue;        // 0x0180(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BeginDialogue_ReturnValue;                // 0x0188(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_189[0x7];                                      // 0x0189(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue;                  // 0x0190(0x0008)(NoDestructor, HasGetValueTypeHash)
	class UUserWidget*                            CallFunc_SetupInventoryWidget_InventoryWidgetRef;  // 0x0198(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInventoryVisible__Result;               // 0x01A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddJigWidgetToContent_Result;             // 0x01A1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayTag                           K2Node_Event_Option_1;                             // 0x01B0(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_RequestServerData_Result;                 // 0x01F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster) == 0x000260, "Wrong size on BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster");
...
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x000004, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_ComponentBoundEvent_LayerIndex) == 0x000008, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_ComponentBoundEvent_LayerIndex' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_ComponentBoundEvent_bIsSeen) == 0x00000C, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_ComponentBoundEvent_bIsSeen' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_Option_2) == 0x000010, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_Option_2' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_SwitchInteger_CmpSuccess) == 0x000018, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_InteractingActor_3) == 0x000020, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_InteractingActor_3' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_MakeMap_Map) == 0x000028, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_MakeMap_Map' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_MakeMap_Map_1) == 0x000078, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_MakeMap_Map_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_InteractingActor_2) == 0x0000C8, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_InteractingActor_2' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_MakeMap_Map_2) == 0x0000D0, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_MakeMap_Map_2' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_GetBoolCVar_ReturnValue) == 0x000120, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_GetHUD_HUD) == 0x000128, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_GetHUD_HUD' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_GetHUD_HUD_1) == 0x000130, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_GetHUD_HUD_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_DynamicCast_AsBP_Jig_Character_Interface) == 0x000138, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_DynamicCast_AsBP_Jig_Character_Interface' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_DynamicCast_bSuccess) == 0x000148, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_DynamicCast_AsBP_Jig_Character_Interface_1) == 0x000150, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_DynamicCast_AsBP_Jig_Character_Interface_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_DynamicCast_bSuccess_1) == 0x000160, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000168, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_GetNarrativeComponent_ReturnValue) == 0x000180, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_GetNarrativeComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_BeginDialogue_ReturnValue) == 0x000188, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_BeginDialogue_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_K2_SetTimer_ReturnValue) == 0x000190, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_SetupInventoryWidget_InventoryWidgetRef) == 0x000198, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_SetupInventoryWidget_InventoryWidgetRef' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_IsInventoryVisible__Result) == 0x0001A0, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_IsInventoryVisible__Result' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_AddJigWidgetToContent_Result) == 0x0001A1, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_AddJigWidgetToContent_Result' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_Not_PreBool_ReturnValue) == 0x0001A2, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_K2_SetTimer_ReturnValue_1) == 0x0001A8, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_K2_SetTimer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_Option_1) == 0x0001B0, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_Option_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_ByActor) == 0x0001B8, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_ByActor' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_Payload) == 0x0001C0, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_Payload' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, CallFunc_RequestServerData_Result) == 0x0001F0, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::CallFunc_RequestServerData_Result' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_InteractingActor_1) == 0x0001F8, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_Option) == 0x000200, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_InteractingActor) == 0x000208, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster, K2Node_Event_Options) == 0x000210, "Member 'BP_TraderMaster_C_ExecuteUbergraph_BP_TraderMaster::K2Node_Event_Options' has a wrong offset!");
