...
public:
	...
	double                                        CallFunc_RandomFloatInRange_ReturnValue_2;         // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_K2_TimerExistsHandle_ReturnValue_1;       // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_132[0x2];                                      // 0x0132(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_CustomEvent_MedicalEffect;                  // 0x0134(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_Adding_;                        // 0x013C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_K2_TimerExistsHandle_ReturnValue_2;       // 0x013D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 K2Node_CustomEvent_DamagedActor;                   // 0x0170(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_BaseDamage;                     // 0x0178(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1;  // 0x0194(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_2;  // 0x0198(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent) == 0x0001A0, "Wrong size on MedicalComponent_C_ExecuteUbergraph_MedicalComponent");
...
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_RandomFloatInRange_ReturnValue) == 0x000100, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000108, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x000110, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_ReturnValue_1) == 0x000118, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_RandomFloatInRange_ReturnValue_2) == 0x000120, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_RandomFloatInRange_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_ReturnValue_2) == 0x000128, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_TimerExistsHandle_ReturnValue) == 0x000130, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_TimerExistsHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_TimerExistsHandle_ReturnValue_1) == 0x000131, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_TimerExistsHandle_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_CustomEvent_MedicalEffect) == 0x000134, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_CustomEvent_MedicalEffect' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_CustomEvent_Adding_) == 0x00013C, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_CustomEvent_Adding_' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_TimerExistsHandle_ReturnValue_2) == 0x00013D, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_TimerExistsHandle_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_GetOwner_ReturnValue) == 0x000140, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_DynamicCast_AsBP_Player_Character) == 0x000148, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_DynamicCast_AsBP_Player_Character' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_DynamicCast_bSuccess) == 0x000150, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_GetOwner_ReturnValue_1) == 0x000158, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_GetOwner_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_DynamicCast_AsBP_Player_Character_1) == 0x000160, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_DynamicCast_AsBP_Player_Character_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_DynamicCast_bSuccess_1) == 0x000168, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_CustomEvent_DamagedActor) == 0x000170, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_CustomEvent_DamagedActor' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, K2Node_CustomEvent_BaseDamage) == 0x000178, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::K2Node_CustomEvent_BaseDamage' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_ApplyDamage_ReturnValue) == 0x00017C, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_ApplyDamage_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_IsValid_ReturnValue) == 0x000180, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, Temp_int_Loop_Counter_Variable) == 0x000184, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_Less_IntInt_ReturnValue) == 0x000188, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_Add_IntInt_ReturnValue) == 0x00018C, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000190, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1) == 0x000194, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(MedicalComponent_C_ExecuteUbergraph_MedicalComponent, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_2) == 0x000198, "Member 'MedicalComponent_C_ExecuteUbergraph_MedicalComponent::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_2' has a wrong offset!");
