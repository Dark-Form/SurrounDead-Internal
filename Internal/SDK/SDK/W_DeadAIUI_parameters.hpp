...
public:
	...
	bool                                          CallFunc_CanStack__CanStack;                       // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_CanStack__FreeSpaceAvailable;             // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UJSI_Slot_C*                            K2Node_Event_ItemRef;                              // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_ActorRef;                             // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_Event_NewWeight;                            // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUserWidget*                            K2Node_Event_Widget;                               // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FText                                   K2Node_Event_Name;                                 // 0x0048(0x0018)()
	class UBP_InspectorWindowWidget_C*            K2Node_Event_Inspector;                            // 0x0060(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_JSI_CheckIfCanAddItemToContainer_Result;  // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UJSIContainer_C*                        CallFunc_JSI_CheckIfCanAddItemToContainer_AddToContainer; // 0x0080(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_JSI_CheckIfCanAddItemToContainer_ToIndex; // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_JSI_CheckIfCanAddItemToContainer_FinalRotation; // 0x008C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_JSI_CheckIfCanAddStackItemToContainer_Result; // 0x008D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8E[0x2];                                       // 0x008E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UJSI_Slot_C*                            CallFunc_JSI_CheckIfCanAddStackItemToContainer_WithItem; // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI) == 0x0000A0, "Wrong size on W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI");
...
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Array_Length_ReturnValue) == 0x000004, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, Temp_int_Array_Index_Variable) == 0x000008, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, Temp_int_Loop_Counter_Variable) == 0x00000C, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Array_Get_Item) == 0x000010, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_GetCount_Count) == 0x000018, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_GetCount_Count' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_CanStack__CanStack) == 0x00001C, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_CanStack__CanStack' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_CanStack__FreeSpaceAvailable) == 0x00001D, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_CanStack__FreeSpaceAvailable' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Less_IntInt_ReturnValue) == 0x00001E, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_ItemRef) == 0x000028, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_ItemRef' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_ActorRef) == 0x000030, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_ActorRef' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_NewWeight) == 0x000038, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_NewWeight' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_Widget) == 0x000040, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_Widget' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_Name) == 0x000048, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_Name' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, K2Node_Event_Inspector) == 0x000060, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::K2Node_Event_Inspector' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_GetOwningPlayerPawn_ReturnValue) == 0x000068, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_GetOwningPlayerPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_GetComponentByClass_ReturnValue) == 0x000070, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddItemToContainer_Result) == 0x000078, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddItemToContainer_Result' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddItemToContainer_AddToContainer) == 0x000080, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddItemToContainer_AddToContainer' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddItemToContainer_ToIndex) == 0x000088, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddItemToContainer_ToIndex' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddItemToContainer_FinalRotation) == 0x00008C, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddItemToContainer_FinalRotation' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddStackItemToContainer_Result) == 0x00008D, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddStackItemToContainer_Result' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_JSI_CheckIfCanAddStackItemToContainer_WithItem) == 0x000090, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_JSI_CheckIfCanAddStackItemToContainer_WithItem' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Array_Length_ReturnValue_1) == 0x000098, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI, CallFunc_Greater_IntInt_ReturnValue) == 0x00009C, "Member 'W_DeadAIUI_C_ExecuteUbergraph_W_DeadAIUI::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
