...
static_assert(sizeof(UVehicleHealthComponent_C) == 0x0000F0, "Wrong size on UVehicleHealthComponent_C");
...
static_assert(offsetof(UVehicleHealthComponent_C, PlayerRef) == 0x0000E8, "Member 'UVehicleHealthComponent_C::PlayerRef' has a wrong offset!");
