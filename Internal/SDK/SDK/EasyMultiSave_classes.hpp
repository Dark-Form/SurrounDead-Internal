...
static_assert(alignof(IEMSActorSaveInterface) == 0x000001, "Wrong alignment on IEMSActorSaveInterface");
static_assert(sizeof(IEMSActorSaveInterface) == 0x000001, "Wrong size on IEMSActorSaveInterface");
...
static_assert(alignof(IEMSCompSaveInterface) == 0x000001, "Wrong alignment on IEMSCompSaveInterface");
static_assert(sizeof(IEMSCompSaveInterface) == 0x000001, "Wrong size on IEMSCompSaveInterface");
...
public:
	...
	TMulticastInlineDelegate<void(const class APlayerController* LoadedPlayer)> OnPlayerLoaded;      // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<TSoftObjectPtr<class AActor>>& LoadedActors)> OnLevelLoaded; // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<TSoftObjectPtr<class AActor>>& LoadedActors)> OnPartitionLoaded; // 0x0070(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
