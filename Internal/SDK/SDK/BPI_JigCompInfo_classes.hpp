...
class IBPI_JigCompInfo_C final
{
public:
...
static_assert(alignof(IBPI_JigCompInfo_C) == 0x000001, "Wrong alignment on IBPI_JigCompInfo_C");
static_assert(sizeof(IBPI_JigCompInfo_C) == 0x000001, "Wrong size on IBPI_JigCompInfo_C");
