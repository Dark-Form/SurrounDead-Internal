...
// Parameters:
// const class ABP_Audio_Area_C*&          NewArea                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// const TArray<struct FST_Audio>&         TargetArray                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// const struct FReverbSettings&           ReverbSettings                                         (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
