...
void ABP_ZombieAIController_C::BndEvt__BP_ZombieAIController_AIPerception_K2Node_ComponentBoundEvent_2_ActorPerceptionUpdatedDelegate__DelegateSignature(class AActor* Actor, const struct FAIStimulus& Stimulus)
{
	...
	Params::BP_ZombieAIController_C_BndEvt__BP_ZombieAIController_AIPerception_K2Node_ComponentBoundEvent_2_ActorPerceptionUpdatedDelegate__DelegateSignature Parms{};
...
// Parameters:
// const struct FVector&                   StimulusLoc                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector&                   ReceiverLoc                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   Heard                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_ZombieAIController_C::HearingTrace(const struct FVector& StimulusLoc, const struct FVector& ReceiverLoc, bool* Heard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieAIController_C", "HearingTrace");

	Params::BP_ZombieAIController_C_HearingTrace Parms{};

	Parms.StimulusLoc = std::move(StimulusLoc);
	Parms.ReceiverLoc = std::move(ReceiverLoc);
