...
public:
	...
	class UBlendSpace1D*                          K2Node_PropertyAccess_2;                           // 0x0738(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_PropertyAccess_1;                           // 0x0740(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_PropertyAccess;                             // 0x0758(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Dead;                                              // 0x0759(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_75A[0x6];                                      // 0x075A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        Speed;                                             // 0x0760(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsZombie_;                                         // 0x0768(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Falling_;                                          // 0x0769(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_76A[0x6];                                      // 0x076A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UBlendSpace1D*                          Movement_Blendspace;                               // 0x0770(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class ABP_MasterZombie_C*                     ZombieRef;                                         // 0x0778(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UAnimBP_Zombie_C, K2Node_PropertyAccess_2) == 0x000738, "Member 'UAnimBP_Zombie_C::K2Node_PropertyAccess_2' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, K2Node_PropertyAccess_1) == 0x000740, "Member 'UAnimBP_Zombie_C::K2Node_PropertyAccess_1' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, K2Node_PropertyAccess) == 0x000758, "Member 'UAnimBP_Zombie_C::K2Node_PropertyAccess' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, Dead) == 0x000759, "Member 'UAnimBP_Zombie_C::Dead' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, Speed) == 0x000760, "Member 'UAnimBP_Zombie_C::Speed' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, IsZombie_) == 0x000768, "Member 'UAnimBP_Zombie_C::IsZombie_' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, Falling_) == 0x000769, "Member 'UAnimBP_Zombie_C::Falling_' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, Movement_Blendspace) == 0x000770, "Member 'UAnimBP_Zombie_C::Movement_Blendspace' has a wrong offset!");
static_assert(offsetof(UAnimBP_Zombie_C, ZombieRef) == 0x000778, "Member 'UAnimBP_Zombie_C::ZombieRef' has a wrong offset!");
