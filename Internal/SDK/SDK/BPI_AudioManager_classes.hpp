...
class IBPI_AudioManager_C final
{
public:
...
static_assert(alignof(IBPI_AudioManager_C) == 0x000001, "Wrong alignment on IBPI_AudioManager_C");
static_assert(sizeof(IBPI_AudioManager_C) == 0x000001, "Wrong size on IBPI_AudioManager_C");
