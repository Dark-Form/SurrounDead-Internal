...
public:
	...
	class FText                                   AIName;                                            // 0x0720(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	TMulticastInlineDelegate<void()>              DeathEvent;                                        // 0x0810(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void AttackPlayer();
	void AttackTrace();
	void BndEvt__BP_MasterZombie_DamageComponent_K2Node_ComponentBoundEvent_1_Death__DelegateSignature(class AActor* DmgCauser);
...
static_assert(offsetof(ABP_MasterZombie_C, AIName) == 0x000720, "Member 'ABP_MasterZombie_C::AIName' has a wrong offset!");
