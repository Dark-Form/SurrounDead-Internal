...
public:
	...
	bool                                          CallFunc_GetBoolCVar_ReturnValue;                  // 0x02F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_bIsBeyondLastLayer;     // 0x02F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2FA[0x2];                                      // 0x02FA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_ComponentBoundEvent_LayerIndex;             // 0x02FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_bIsSeen;                // 0x0300(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_Conv_DoubleToText_ReturnValue_1;          // 0x0318(0x0018)()
	class FText                                   CallFunc_Append_Text_Return_Value_1;               // 0x0330(0x0018)()
	TMap<class FName, class FText>                K2Node_MakeMap_Map_4;                              // 0x0348(0x0050)()
	float                                         CallFunc_RetriggerableDelay_Duration_ImplicitCast; // 0x0398(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster) == 0x0003A0, "Wrong size on Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster");
...
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, CallFunc_GetBoolCVar_ReturnValue) == 0x0002F8, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x0002F9, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, K2Node_ComponentBoundEvent_LayerIndex) == 0x0002FC, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::K2Node_ComponentBoundEvent_LayerIndex' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, K2Node_ComponentBoundEvent_bIsSeen) == 0x000300, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::K2Node_ComponentBoundEvent_bIsSeen' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000308, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x000310, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, CallFunc_Conv_DoubleToText_ReturnValue_1) == 0x000318, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::CallFunc_Conv_DoubleToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster, CallFunc_Append_Text_Return_Value_1) == 0x000330, "Member 'Buildable_GeneratorMaster_C_ExecuteUbergraph_Buildable_GeneratorMaster::CallFunc_Append_Text_Return_Value_1' has a wrong offset!");
