...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Vehicle_RV_C;                       // 0x04D0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AVehicle_RV_C) == 0x0004D8, "Wrong size on AVehicle_RV_C");
static_assert(offsetof(AVehicle_RV_C, UberGraphFrame_Vehicle_RV_C) == 0x0004D0, "Member 'AVehicle_RV_C::UberGraphFrame_Vehicle_RV_C' has a wrong offset!");
