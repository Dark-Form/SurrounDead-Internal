...
class IBP_WeaponAttachments_C final
{
public:
...
static_assert(alignof(IBP_WeaponAttachments_C) == 0x000001, "Wrong alignment on IBP_WeaponAttachments_C");
static_assert(sizeof(IBP_WeaponAttachments_C) == 0x000001, "Wrong size on IBP_WeaponAttachments_C");
