...
static_assert(sizeof(Buildable_Bed_C_ExecuteUbergraph_Buildable_Bed) == 0x0001E8, "Wrong size on Buildable_Bed_C_ExecuteUbergraph_Buildable_Bed");
...
static_assert(offsetof(Buildable_Bed_C_ExecuteUbergraph_Buildable_Bed, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x0001D8, "Member 'Buildable_Bed_C_ExecuteUbergraph_Buildable_Bed::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
