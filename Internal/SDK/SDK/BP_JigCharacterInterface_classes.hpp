...
class IBP_JigCharacterInterface_C final
{
public:
...
static_assert(alignof(IBP_JigCharacterInterface_C) == 0x000001, "Wrong alignment on IBP_JigCharacterInterface_C");
static_assert(sizeof(IBP_JigCharacterInterface_C) == 0x000001, "Wrong size on IBP_JigCharacterInterface_C");
