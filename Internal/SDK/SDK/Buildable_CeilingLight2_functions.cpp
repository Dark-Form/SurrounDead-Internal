...
void ABuildable_CeilingLight2_C::OnServerExecuteInteract(const struct FGameplayTag& Option, class AActor* ByActor, const struct FS_JigPayload& Payload)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buildable_CeilingLight2_C", "OnServerExecuteInteract");

	Params::Buildable_CeilingLight2_C_OnServerExecuteInteract Parms{};
