...
public:
	...
	TMulticastInlineDelegate<void(const struct FHitResult& HitResult, class UPrimitiveComponent* CollidingComponent)> OnHit; // 0x0170(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
class ICCRotatingOwnerInterface final
{
public:
...
static_assert(alignof(ICCRotatingOwnerInterface) == 0x000001, "Wrong alignment on ICCRotatingOwnerInterface");
static_assert(sizeof(ICCRotatingOwnerInterface) == 0x000001, "Wrong size on ICCRotatingOwnerInterface");
