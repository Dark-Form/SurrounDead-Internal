...
class IJSISpecialWidgetInterface_C final
{
public:
...
static_assert(alignof(IJSISpecialWidgetInterface_C) == 0x000001, "Wrong alignment on IJSISpecialWidgetInterface_C");
static_assert(sizeof(IJSISpecialWidgetInterface_C) == 0x000001, "Wrong size on IJSISpecialWidgetInterface_C");
