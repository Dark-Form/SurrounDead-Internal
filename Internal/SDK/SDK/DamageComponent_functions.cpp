...
void UDamageComponent_C::DamageTaken(double DmgAmount, class AActor* DmgCauser)
{
	static class UFunction* Func = nullptr;
...
void UDamageComponent_C::OnBloodSplatterFX(class FName EventName, float EmitterTime, int32 ParticleTime, const struct FVector& Location, const struct FVector& Velocity, const struct FVector& Direction, const struct FVector& Normal, class FName BoneName, class UPhysicalMaterial* PhysMat)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DamageComponent_C", "OnBloodSplatterFX");

	Params::DamageComponent_C_OnBloodSplatterFX Parms{};
