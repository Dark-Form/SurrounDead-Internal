...
void IBP_AIInterface_C::Actor_Aim_Focus(class AActor* Instigator)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Actor Aim Focus");
...
void IBP_AIInterface_C::Actor_Attack_Target(class AActor** Attack_Target)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Actor Attack Target");
...
void IBP_AIInterface_C::AI_Alert(class AActor* Alert_Actor)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Alert");
...
void IBP_AIInterface_C::AI_Animation_Switch(E_AIBehaviour Behaviour)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Animation Switch");
...
void IBP_AIInterface_C::AI_Block(E_BlockType Block_Type, class AActor* Block_Attacker)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Block");
...
void IBP_AIInterface_C::AI_Camera_Activate(bool Activate)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Camera Activate");
...
void IBP_AIInterface_C::AI_Can_Interact_(bool* Can_Interact)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Can Interact?");
...
void IBP_AIInterface_C::AI_Dead()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Dead");
...
void IBP_AIInterface_C::AI_End_Alert()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI End Alert");
...
void IBP_AIInterface_C::Alert_Actor_Defenders(class AActor* Attacked, class AActor* Attacker)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Alert Actor Defenders");
...
void IBP_AIInterface_C::Turret_Destroyed_Effect()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Turret Destroyed Effect");
...
void IBP_AIInterface_C::Turret_End_Reload()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Turret End Reload");
...
void IBP_AIInterface_C::Turret_Idle_Start()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Turret Idle Start");
...
void IBP_AIInterface_C::Turret_Idle_Stop()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Turret Idle Stop");
...
void IBP_AIInterface_C::Turret_Start_Reload()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "Turret Start Reload");
...
void IBP_AIInterface_C::AI_Is_Dead_(bool* Dead) const
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIInterface_C", "AI Is Dead?");
