...
public:
	...
	TMulticastInlineDelegate<void(double SightRange, double Peripheral)> UpdateSightValues;          // 0x00C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(USD_AIComponent_C) == 0x0000D8, "Wrong size on USD_AIComponent_C");
...
static_assert(offsetof(USD_AIComponent_C, UpdateSightValues) == 0x0000C8, "Member 'USD_AIComponent_C::UpdateSightValues' has a wrong offset!");
