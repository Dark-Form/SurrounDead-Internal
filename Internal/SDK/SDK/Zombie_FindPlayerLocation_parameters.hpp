...
public:
	...
	bool                                          CallFunc_ActorHasTag_ReturnValue;                  // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation) == 0x000090, "Wrong size on Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation");
...
static_assert(offsetof(Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000070, "Member 'Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation, CallFunc_ActorHasTag_ReturnValue) == 0x000088, "Member 'Zombie_FindPlayerLocation_C_ExecuteUbergraph_Zombie_FindPlayerLocation::CallFunc_ActorHasTag_ReturnValue' has a wrong offset!");
