...
public:
	...
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD_1;                             // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ACharacter*                             CallFunc_GetPlayerCharacter_ReturnValue;           // 0x0218(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_PlayAnimMontage_ReturnValue;              // 0x0220(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<struct FGameplayTag, class FText>        K2Node_Event_Options;                              // 0x0240(0x0050)(ConstParm)
};
...
static_assert(sizeof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator) == 0x000290, "Wrong size on BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator");
...
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, CallFunc_GetHUD_HUD_1) == 0x000208, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::CallFunc_GetHUD_HUD_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, CallFunc_GetBoolCVar_ReturnValue) == 0x000210, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, CallFunc_GetPlayerCharacter_ReturnValue) == 0x000218, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, CallFunc_PlayAnimMontage_ReturnValue) == 0x000220, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::CallFunc_PlayAnimMontage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, K2Node_Event_InteractingActor_1) == 0x000228, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, K2Node_Event_Option) == 0x000230, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, K2Node_Event_InteractingActor) == 0x000238, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator, K2Node_Event_Options) == 0x000240, "Member 'BP_LaboratoryGenerator_C_ExecuteUbergraph_BP_LaboratoryGenerator::K2Node_Event_Options' has a wrong offset!");
