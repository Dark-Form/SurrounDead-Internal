...
public:
	...
	void ShowInteractWidget(bool Visible_, const class FText& Name_0, const class FText& AdditionalText, const TMap<struct FGameplayTag, class FText>& Options, const TMap<class FName, class FText>& Stats);
