...
public:
	...
	bool                                          Temp_bool_IsClosed_Variable_1;                     // 0x0448(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_449[0x7];                                      // 0x0449(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNarrativeComponent*                    CallFunc_GetNarrativeComponent_ReturnValue;        // 0x0450(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BeginDialogue_ReturnValue;                // 0x0458(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<struct FGameplayTag, class FText>        K2Node_Event_Options;                              // 0x0468(0x0050)(ConstParm)
	class AActor*                                 K2Node_Event_InteractingActor;                     // 0x04B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_Option;                               // 0x04C0(0x0008)(NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface; // 0x04C8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1; // 0x04E0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue;                  // 0x04F8(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue_1;                // 0x0500(0x0008)(NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_RequestServerData_Result;                 // 0x0508(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_509[0x7];                                      // 0x0509(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUserWidget*                            CallFunc_SetupInventoryWidget_InventoryWidgetRef;  // 0x0510(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddJigWidgetToContent_Result;             // 0x0518(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTransform                             Temp_struct_Variable;                              // 0x0530(0x0060)(ConstParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue;          // 0x0590(0x0008)(NoDestructor, HasGetValueTypeHash)
	class UParticleSystemComponent*               CallFunc_AddComponent_ReturnValue;                 // 0x0598(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_CustomEvent_NewValue;                       // 0x05A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5AC[0x4];                                      // 0x05AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_Multiply_DoubleDouble_ReturnValue_4;      // 0x05B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_ScalingHealthMultiplier_NewMaxHealth;     // 0x05B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_FTrunc_ReturnValue;                       // 0x05C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAIOSubjectHandle                      CallFunc_K2_DespawnSubject_SubjectHandle;          // 0x05C4(0x0004)(NoDestructor)
	bool                                          CallFunc_K2_DespawnSubject_ReturnValue;            // 0x05C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5C9[0x3];                                      // 0x05C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x05CC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5DC[0x4];                                      // 0x05DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue_1;        // 0x05E0(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FS_AttachedHoldables                   CallFunc_Array_Get_Item_8;                         // 0x05E8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader) == 0x000610, "Wrong size on BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader");
...
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, Temp_bool_IsClosed_Variable_1) == 0x000448, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::Temp_bool_IsClosed_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_GetNarrativeComponent_ReturnValue) == 0x000450, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_GetNarrativeComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_BeginDialogue_ReturnValue) == 0x000458, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_BeginDialogue_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_Event_InteractingActor_1) == 0x000460, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_Event_Options) == 0x000468, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_Event_Options' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_Event_InteractingActor) == 0x0004B8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_Event_Option) == 0x0004C0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_DynamicCast_AsBP_Jig_Character_Interface) == 0x0004C8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_DynamicCast_AsBP_Jig_Character_Interface' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_DynamicCast_bSuccess) == 0x0004D8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_DynamicCast_AsBP_Jig_Character_Interface_1) == 0x0004E0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_DynamicCast_AsBP_Jig_Character_Interface_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_DynamicCast_bSuccess_1) == 0x0004F0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_SetTimer_ReturnValue) == 0x0004F8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_SetTimer_ReturnValue_1) == 0x000500, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_SetTimer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_RequestServerData_Result) == 0x000508, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_RequestServerData_Result' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_SetupInventoryWidget_InventoryWidgetRef) == 0x000510, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_SetupInventoryWidget_InventoryWidgetRef' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_AddJigWidgetToContent_Result) == 0x000518, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_AddJigWidgetToContent_Result' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_CreateDelegate_OutputDelegate_1) == 0x00051C, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, Temp_struct_Variable) == 0x000530, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000590, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_AddComponent_ReturnValue) == 0x000598, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_AddComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Conv_IntToDouble_ReturnValue) == 0x0005A0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_CustomEvent_NewValue) == 0x0005A8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_CustomEvent_NewValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Multiply_DoubleDouble_ReturnValue_4) == 0x0005B0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Multiply_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_ScalingHealthMultiplier_NewMaxHealth) == 0x0005B8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_ScalingHealthMultiplier_NewMaxHealth' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_FTrunc_ReturnValue) == 0x0005C0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_DespawnSubject_SubjectHandle) == 0x0005C4, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_DespawnSubject_SubjectHandle' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_DespawnSubject_ReturnValue) == 0x0005C8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_DespawnSubject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, K2Node_CreateDelegate_OutputDelegate_2) == 0x0005CC, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_K2_SetTimerDelegate_ReturnValue_1) == 0x0005E0, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_K2_SetTimerDelegate_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Array_Get_Item_8) == 0x0005E8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Array_Get_Item_8' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Array_Length_ReturnValue) == 0x0005F8, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Less_IntInt_ReturnValue) == 0x0005FC, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_ApplyDamage_BaseDamage_ImplicitCast) == 0x000600, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_ApplyDamage_BaseDamage_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Delay_Duration_ImplicitCast) == 0x000604, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000608, "Member 'BP_MasterTrader_C_ExecuteUbergraph_BP_MasterTrader::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
