...
public:
	...
	struct FS_MarkerData                          K2Node_MakeStruct_S_MarkerData;                    // 0x0010(0x0070)(HasGetValueTypeHash)
	class UW_WorldMarker_C*                       CallFunc_Add_World_Marker_Markers;                 // 0x0080(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_Marker_C_ExecuteUbergraph_BP_Marker) == 0x000088, "Wrong size on BP_Marker_C_ExecuteUbergraph_BP_Marker");
...
static_assert(offsetof(BP_Marker_C_ExecuteUbergraph_BP_Marker, K2Node_MakeStruct_S_MarkerData) == 0x000010, "Member 'BP_Marker_C_ExecuteUbergraph_BP_Marker::K2Node_MakeStruct_S_MarkerData' has a wrong offset!");
static_assert(offsetof(BP_Marker_C_ExecuteUbergraph_BP_Marker, CallFunc_Add_World_Marker_Markers) == 0x000080, "Member 'BP_Marker_C_ExecuteUbergraph_BP_Marker::CallFunc_Add_World_Marker_Markers' has a wrong offset!");
