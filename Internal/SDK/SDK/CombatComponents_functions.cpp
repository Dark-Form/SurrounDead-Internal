...
// const TArray<class FName>&              Sockets                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const TArray<struct FCCCollidingComponent>&collidingComponents                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
struct FRotator ICCRotatingOwnerInterface::GetDesiredRotation()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("CCRotatingOwnerInterface", "GetDesiredRotation");
