...
public:
	...
	bool                                          CallFunc_AddNewInventoryItem_Added;                // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_AddNewInventoryItem_SlotIndex;            // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UJigsawItem_DataAsset_C*                CallFunc_AddNewInventoryItem_ItemInfo;             // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UJSI_Slot_C*                            CallFunc_AddNewInventoryItem_SlotItemRef;          // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddNewInventoryItem_Stacked_;             // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_PlayerCraftingUI_C_InitializeInventory) == 0x000108, "Wrong size on W_PlayerCraftingUI_C_InitializeInventory");
...
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_GetPlayerPawn_ReturnValue) == 0x0000C8, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_GetPlayerPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_AddNewInventoryItem_Added) == 0x0000D0, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_AddNewInventoryItem_Added' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_AddNewInventoryItem_SlotIndex) == 0x0000D4, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_AddNewInventoryItem_SlotIndex' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_AddNewInventoryItem_ItemInfo) == 0x0000D8, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_AddNewInventoryItem_ItemInfo' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_AddNewInventoryItem_SlotItemRef) == 0x0000E0, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_AddNewInventoryItem_SlotItemRef' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_AddNewInventoryItem_Stacked_) == 0x0000E8, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_AddNewInventoryItem_Stacked_' has a wrong offset!");
...
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, Temp_int_Loop_Counter_Variable) == 0x0000FC, "Member 'W_PlayerCraftingUI_C_InitializeInventory::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_Not_PreBool_ReturnValue) == 0x000100, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_Less_IntInt_ReturnValue) == 0x000101, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_PlayerCraftingUI_C_InitializeInventory, CallFunc_Add_IntInt_ReturnValue) == 0x000104, "Member 'W_PlayerCraftingUI_C_InitializeInventory::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
