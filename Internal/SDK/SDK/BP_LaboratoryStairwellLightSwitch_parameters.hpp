...
public:
	...
	float                                         CallFunc_PlayAnimMontage_ReturnValue;              // 0x01F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch) == 0x000200, "Wrong size on BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch");
...
static_assert(offsetof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch, K2Node_Event_InteractingActor_1) == 0x000180, "Member 'BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch, K2Node_Event_Option) == 0x000188, "Member 'BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch, CallFunc_GetPlayerCharacter_ReturnValue) == 0x000190, "Member 'BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch, K2Node_Event_InteractingActor) == 0x000198, "Member 'BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch, K2Node_Event_Options) == 0x0001A0, "Member 'BP_LaboratoryStairwellLightSwitch_C_ExecuteUbergraph_BP_LaboratoryStairwellLightSwitch::K2Node_Event_Options' has a wrong offset!");
