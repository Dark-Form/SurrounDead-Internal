...
static_assert(sizeof(Bear_FindPlayerLocation_C_ExecuteUbergraph_Bear_FindPlayerLocation) == 0x000070, "Wrong size on Bear_FindPlayerLocation_C_ExecuteUbergraph_Bear_FindPlayerLocation");
...
static_assert(offsetof(Bear_FindPlayerLocation_C_ExecuteUbergraph_Bear_FindPlayerLocation, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000058, "Member 'Bear_FindPlayerLocation_C_ExecuteUbergraph_Bear_FindPlayerLocation::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
