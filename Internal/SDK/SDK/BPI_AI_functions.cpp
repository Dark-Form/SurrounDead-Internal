...
void IBPI_AI_C::AddMarker(class UWidgetComponent* Marker)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "AddMarker");
...
void IBPI_AI_C::AIHealthBarInfo(bool* Visible_, class FString* Name_0, bool* Boss_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "AIHealthBarInfo");
...
void IBPI_AI_C::CanAddMarkerToAI_(bool* CanAdd_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "CanAddMarkerToAI?");
...
void IBPI_AI_C::CanStompAI_(bool* Stomp_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "CanStompAI?");
...
void IBPI_AI_C::GetMarker(class UTexture2D** Texture, struct FLinearColor* Color, double* MarkerOffset)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "GetMarker");
...
void IBPI_AI_C::GetMesh(class USkeletalMeshComponent** Mesh)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "GetMesh");
...
void IBPI_AI_C::GetMovementSpeeds(double* RoamingSpeed, double* AlertSpeed, double* AttackSpeed)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "GetMovementSpeeds");
...
void IBPI_AI_C::HitByVehicle(double Speed, const struct FVector& Direction)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "HitByVehicle");
...
void IBPI_AI_C::IsAIBurning_(bool* IsBurning_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "IsAIBurning?");
...
void IBPI_AI_C::OverrideName(const class FString& Name_0)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "OverrideName");
...
void IBPI_AI_C::SetBurning(bool Burning_, double Dmg, class AActor* Actor)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_AI_C", "SetBurning");
