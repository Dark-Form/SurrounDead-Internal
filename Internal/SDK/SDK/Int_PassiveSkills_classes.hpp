...
class IInt_PassiveSkills_C final
{
public:
...
static_assert(alignof(IInt_PassiveSkills_C) == 0x000001, "Wrong alignment on IInt_PassiveSkills_C");
static_assert(sizeof(IInt_PassiveSkills_C) == 0x000001, "Wrong size on IInt_PassiveSkills_C");
