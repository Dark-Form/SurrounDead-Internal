...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Buildable_SmallConcreteWall_C;      // 0x0428(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABuildable_SmallConcreteWall_C) == 0x000438, "Wrong size on ABuildable_SmallConcreteWall_C");
static_assert(offsetof(ABuildable_SmallConcreteWall_C, UberGraphFrame_Buildable_SmallConcreteWall_C) == 0x000428, "Member 'ABuildable_SmallConcreteWall_C::UberGraphFrame_Buildable_SmallConcreteWall_C' has a wrong offset!");
static_assert(offsetof(ABuildable_SmallConcreteWall_C, Sphere) == 0x000430, "Member 'ABuildable_SmallConcreteWall_C::Sphere' has a wrong offset!");
