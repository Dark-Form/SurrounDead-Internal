...
// const struct FVector&                   End_Climb_Location_0                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_MasterAICharacter_C::OnCollide(class FName EventName, float EmitterTime, int32 ParticleTime, const struct FVector& Location, const struct FVector& Velocity, const struct FVector& Direction, const struct FVector& Normal, class FName BoneName, class UPhysicalMaterial* PhysMat)
{
	...
	Params::BP_MasterAICharacter_C_OnCollide Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FTransform&                End_Location_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
