...
{
public:
	TMulticastInlineDelegate<void(const class UNarrativeDataTask* NarrativeTask, const class FString& Name)> OnNarrativeDataTaskCompleted; // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UQuestBranch* Branch)> OnQuestBranchCompleted; // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UQuest* Quest, const class UQuestState* NewState)> OnQuestNewState; // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UNarrativeTask* ProgressedTask, const class UQuestBranch* Branch, int32 OldProgress, int32 NewProgress)> OnQuestTaskProgressChanged; // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UNarrativeTask* CompletedTask, const class UQuestBranch* Branch)> OnQuestTaskCompleted; // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class FText& QuestSucceededMessage)> OnQuestSucceeded; // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class FText& QuestFailedMessage)> OnQuestFailed; // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> OnQuestStarted;                        // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> OnQuestForgotten;                      // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> OnQuestRestarted;                      // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, const bool bStartingNewDialogue)> OnDialogueFinished; // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, const TArray<class UDialogueNode_Player*>& PlayerReplies)> OnDialogueRepliesAvailable; // 0x01D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, class UDialogueNode_NPC* Node, const struct FDialogueLine& DialogueLine, const struct FSpeakerInfo& Speaker)> OnNPCDialogueLineStarted; // 0x01E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, class UDialogueNode_NPC* Node, const struct FDialogueLine& DialogueLine, const struct FSpeakerInfo& Speaker)> OnNPCDialogueLineFinished; // 0x01F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, class UDialogueNode_Player* Node, const struct FDialogueLine& DialogueLine)> OnPlayerDialogueLineStarted; // 0x0200(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UDialogue* Dialogue, class UDialogueNode_Player* Node, const struct FDialogueLine& DialogueLine)> OnPlayerDialogueLineFinished; // 0x0210(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UQuestBranch* Branch)> QuestBranchCompleted; // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UQuest* Quest, const class UQuestState* NewState)> QuestNewState; // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UNarrativeTask* ProgressedTask, const class UQuestBranch* Branch, int32 OldProgress, int32 NewProgress)> QuestTaskProgressChanged; // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class UNarrativeTask* CompletedTask, const class UQuestBranch* Branch)> QuestTaskCompleted; // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class FText& QuestSucceededMessage)> QuestSucceeded; // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest, const class FText& QuestFailedMessage)> QuestFailed; // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> QuestStarted;                          // 0x0140(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> QuestForgotten;                        // 0x0150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(const class UQuest* Quest)> QuestRestarted;                        // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
