...
// const struct FAIStimulus&               AI_Stimulus                                            (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
// const struct FS_GeneralSettings&        AI_Settings                                            (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference, HasGetValueTypeHash)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FS_GeneralSettings&        Transition_From                                        (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference, HasGetValueTypeHash)
// const struct FS_GeneralSettings&        Transition_To                                          (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference, HasGetValueTypeHash)
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class AActor*&                    Look_At_Actor                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)
