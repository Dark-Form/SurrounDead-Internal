...
public:
	...
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD_1;                             // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetBoolCVar_ReturnValue;                  // 0x0260(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_PlayAnimMontage_ReturnValue;              // 0x0270(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_274[0x4];                                      // 0x0274(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_InteractingActor_1;                   // 0x0278(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_Option;                               // 0x0280(0x0008)(NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_InteractingActor;                     // 0x0288(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<struct FGameplayTag, class FText>        K2Node_Event_Options;                              // 0x0290(0x0050)(ConstParm)
	...
	class UBP_InteractWidgetOption_C*             CallFunc_Array_Get_Item_2;                         // 0x03D0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class ABP_LaboratoryLightSwitch_C*            CallFunc_Array_Get_Item_3;                         // 0x03D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_LaboratorySlidingDoor_C*            CallFunc_Array_Get_Item_4;                         // 0x03E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x04E0(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult_1;  // 0x05C8(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	double                                        CallFunc_Lerp_Alpha_ImplicitCast_2;                // 0x06D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Lerp_Alpha_ImplicitCast_3;                // 0x06E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_MakeRotator_Yaw_ImplicitCast_1;           // 0x06E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox) == 0x0006F0, "Wrong size on BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox");
...
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_GetHUD_HUD_1) == 0x000258, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_GetHUD_HUD_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_GetBoolCVar_ReturnValue) == 0x000260, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_GetPlayerCharacter_ReturnValue) == 0x000268, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_PlayAnimMontage_ReturnValue) == 0x000270, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_PlayAnimMontage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_Event_InteractingActor_1) == 0x000278, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_Event_Option) == 0x000280, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_Event_InteractingActor) == 0x000288, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_Event_Options) == 0x000290, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_Event_Options' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_GetGameHUD_HUD) == 0x0002E0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_GetGameHUD_HUD' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x0002E8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Array_Get_Item_2) == 0x0003D0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Array_Get_Item_3) == 0x0003D8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Array_Length_ReturnValue_2) == 0x0003E0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Less_IntInt_ReturnValue_2) == 0x0003E4, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Array_Get_Item_4) == 0x0003E8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x0003F0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Array_Length_ReturnValue_3) == 0x0004D8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Array_Length_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Less_IntInt_ReturnValue_3) == 0x0004DC, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Less_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_K2_SetRelativeLocation_SweepHitResult_1) == 0x0004E0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_K2_SetRelativeLocation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_K2_SetRelativeRotation_SweepHitResult_1) == 0x0005C8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_K2_SetRelativeRotation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x0006B0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_ComponentBoundEvent_LayerIndex) == 0x0006B4, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_ComponentBoundEvent_LayerIndex' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, K2Node_ComponentBoundEvent_bIsSeen) == 0x0006B8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::K2Node_ComponentBoundEvent_bIsSeen' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Lerp_Alpha_ImplicitCast) == 0x0006C0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Lerp_Alpha_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Lerp_Alpha_ImplicitCast_1) == 0x0006C8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Lerp_Alpha_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Lerp_Alpha_ImplicitCast_2) == 0x0006D0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Lerp_Alpha_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_MakeRotator_Yaw_ImplicitCast) == 0x0006D8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_MakeRotator_Yaw_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_Lerp_Alpha_ImplicitCast_3) == 0x0006E0, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_Lerp_Alpha_ImplicitCast_3' has a wrong offset!");
static_assert(offsetof(BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox, CallFunc_MakeRotator_Yaw_ImplicitCast_1) == 0x0006E8, "Member 'BP_LaboratoryCircuitBox_C_ExecuteUbergraph_BP_LaboratoryCircuitBox::CallFunc_MakeRotator_Yaw_ImplicitCast_1' has a wrong offset!");
