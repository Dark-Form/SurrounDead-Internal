...
void IEMSActorSaveInterface::ActorPreLoad()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EMSActorSaveInterface", "ActorPreLoad");
...
// const class FString&                    CustomSaveName                                         (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public)
// Parameters:
// const TWeakObjectPtr<class UEMSAsyncLoadGame>InTask                                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// const class FString&                    SaveSlot                                               (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    Filename                                               (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// const struct FRawObjectSaveData&        Data                                                   (Parm, NativeAccessSpecifierPublic)
