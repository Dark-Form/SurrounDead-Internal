...
class IBP_MpInteractInterface_C final
{
public:
...
static_assert(alignof(IBP_MpInteractInterface_C) == 0x000001, "Wrong alignment on IBP_MpInteractInterface_C");
static_assert(sizeof(IBP_MpInteractInterface_C) == 0x000001, "Wrong size on IBP_MpInteractInterface_C");
