...
public:
	...
	class UTextBlock*                             POIContainer_1;                                    // 0x02F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UW_POIMarkerTooltip_C, POIContainer_1) == 0x0002F8, "Member 'UW_POIMarkerTooltip_C::POIContainer_1' has a wrong offset!");
