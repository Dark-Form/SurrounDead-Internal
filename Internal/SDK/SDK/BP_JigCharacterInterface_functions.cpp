...
// const class FText&                      ContentName                                            (BlueprintVisible, BlueprintReadOnly, Parm)
...
void IBP_JigCharacterInterface_C::AddJigWidgetToContent(class UUserWidget* WidgetRef, const class FText& ContentName, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "AddJigWidgetToContent");
...
void IBP_JigCharacterInterface_C::CancelExfil()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "CancelExfil");
...
void IBP_JigCharacterInterface_C::ExecuteExfil()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "ExecuteExfil");
...
void IBP_JigCharacterInterface_C::GetAnimationInfo(struct FGameplayTag* ActiveSlot, double* Leaning, bool* ADS, bool* Crouched, bool* IsFirstPerson_, class UJigsawItem_DataAsset_C** EquippedDA)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "GetAnimationInfo");
...
void IBP_JigCharacterInterface_C::GetTraceActorsToIgnore(TArray<class AActor*>* Actors)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "GetTraceActorsToIgnore");
...
void IBP_JigCharacterInterface_C::InitiateGameSave()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "InitiateGameSave");
...
void IBP_JigCharacterInterface_C::JigCheckWeaponAmmoCount(bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "JigCheckWeaponAmmoCount");
...
void IBP_JigCharacterInterface_C::OnClientDataRequested(TArray<struct FGuid>& ActionbarUIDs, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "OnClientDataRequested");
...
void IBP_JigCharacterInterface_C::OnInteractActorOverDistance(class AActor* ActorRef, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "OnInteractActorOverDistance");
...
void IBP_JigCharacterInterface_C::OnLoadSavedDataRequested(bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "OnLoadSavedDataRequested");
...
void IBP_JigCharacterInterface_C::OnPickupInteractExecuted(class AActor* PickupRef, class UJSIContainer_C* TargetContainer, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "OnPickupInteractExecuted");
...
void IBP_JigCharacterInterface_C::OnSpecialContainerattachmentUpdated(class UJSI_Slot_C* ItemRef, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "OnSpecialContainerattachmentUpdated");
...
void IBP_JigCharacterInterface_C::RequestServerData(class UActorComponent* TargetComp, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "RequestServerData");
...
void IBP_JigCharacterInterface_C::SetPreviewActor(class AActor* Actor, bool* Result)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "SetPreviewActor");
...
void IBP_JigCharacterInterface_C::StartExfil(double Time)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_JigCharacterInterface_C", "StartExfil");
