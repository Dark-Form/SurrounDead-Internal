...
public:
	...
	class ABP_PlayerCharacter_C*                  CallFunc_GetPlayerRef_Player;                      // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent) == 0x0000E0, "Wrong size on BuildingComponent_C_ExecuteUbergraph_BuildingComponent");
...
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, K2Node_DynamicCast_AsCharacter) == 0x000088, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::K2Node_DynamicCast_AsCharacter' has a wrong offset!");
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, K2Node_DynamicCast_bSuccess) == 0x000090, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, CallFunc_K2_SetTimer_ReturnValue) == 0x000098, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, CallFunc_GetOwner_ReturnValue_1) == 0x0000A0, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::CallFunc_GetOwner_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, CallFunc_HasAuthority_ReturnValue) == 0x0000A8, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BuildingComponent_C_ExecuteUbergraph_BuildingComponent, CallFunc_GetPlayerRef_Player) == 0x0000D0, "Member 'BuildingComponent_C_ExecuteUbergraph_BuildingComponent::CallFunc_GetPlayerRef_Player' has a wrong offset!");
