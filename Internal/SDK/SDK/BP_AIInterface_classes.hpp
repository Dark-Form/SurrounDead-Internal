...
static_assert(alignof(IBP_AIInterface_C) == 0x000001, "Wrong alignment on IBP_AIInterface_C");
static_assert(sizeof(IBP_AIInterface_C) == 0x000001, "Wrong size on IBP_AIInterface_C");
